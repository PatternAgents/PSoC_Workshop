...
/* Signal present */
#define PWM_1_QUAD_INDEX_SIGNAL_PRESENT      (1lu)
#define PWM_1_QUAD_STOP_SIGNAL_PRESENT       (1lu)
...
#define PWM_1_TC_COMP_CAP_MODE               (0lu)
...
#define PWM_1_TC_COUNT_SIGNAL_PRESENT        (1lu)
...
#define PWM_1_TC_COMPARE_VALUE               (30000lu)
#define PWM_1_TC_COMPARE_BUF_VALUE           (65535lu)
#define PWM_1_TC_COMPARE_SWAP                (0lu)

/* PWM Mode */
#define PWM_1_PWM_PERIOD_VALUE               (2048lu)
