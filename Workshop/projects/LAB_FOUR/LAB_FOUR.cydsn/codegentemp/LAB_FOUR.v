// ======================================================================
// LAB_FOUR.v generated from TopDesign.cysch
// 08/26/2015 at 14:31
...
// DieTemp_P4_v1_0(CY_COMPONENT_NAME=DieTemp_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DieTemp, CY_INSTANCE_SHORT_NAME=DieTemp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2 SP1, INSTANCE_NAME=DieTemp, )
...
module top ;
    ...
    cy_annotation_universal_v1_0 VDD_G (
        .connect({
            Net_2296
        })
    );
    defparam VDD_G.comp_name = "Power_v1_0";
    defparam VDD_G.port_names = "T1";
    defparam VDD_G.width = 1;

    cy_annotation_universal_v1_0 Resistor_R (
        .connect({
            Net_2302,
            Net_2297
        })
    );
    defparam Resistor_R.comp_name = "Resistor_v1_0";
    defparam Resistor_R.port_names = "T1, T2";
    defparam Resistor_R.width = 2;
	...
	wire [0:0] tmpOE__P1_0_net;
	wire [0:0] tmpFB_0__P1_0_net;
	wire [0:0] tmpIO_0__P1_0_net;
	wire [0:0] tmpINTERRUPT_0__P1_0_net;
	electrical [0:0] tmpSIOVREF__P1_0_net;

	cy_psoc3_pins_v1_10
		#(.id("b74f461c-d301-4f4b-88f8-156dca3e009e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P1_0
		 (.oe(tmpOE__P1_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__P1_0_net[0:0]}),
		  .io({tmpIO_0__P1_0_net[0:0]}),
		  .siovref(tmpSIOVREF__P1_0_net),
		  .interrupt({tmpINTERRUPT_0__P1_0_net[0:0]}),
		  .annotation({Net_2297}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P1_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 VDD_R (
        .connect({
            Net_2299
        })
    );
    defparam VDD_R.comp_name = "Power_v1_0";
    defparam VDD_R.port_names = "T1";
    defparam VDD_R.width = 1;

    cy_annotation_universal_v1_0 Resistor_G (
        .connect({
            Net_2303,
            Net_2294
        })
    );
    defparam Resistor_G.comp_name = "Resistor_v1_0";
    defparam Resistor_G.port_names = "T1, T2";
    defparam Resistor_G.width = 2;
	...
	wire [0:0] tmpOE__P1_1_net;
	wire [0:0] tmpFB_0__P1_1_net;
	wire [0:0] tmpIO_0__P1_1_net;
	wire [0:0] tmpINTERRUPT_0__P1_1_net;
	electrical [0:0] tmpSIOVREF__P1_1_net;

	cy_psoc3_pins_v1_10
		#(.id("e82e1437-9e23-4b4a-bd4e-9f9042ceb755"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P1_1
		 (.oe(tmpOE__P1_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__P1_1_net[0:0]}),
		  .io({tmpIO_0__P1_1_net[0:0]}),
		  .siovref(tmpSIOVREF__P1_1_net),
		  .interrupt({tmpINTERRUPT_0__P1_1_net[0:0]}),
		  .annotation({Net_2294}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P1_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2bce080a-81db-4d25-b197-29f91993d994"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 SW1_1 (
        .connect({
            Net_2307,
            Net_2309
        })
    );
    defparam SW1_1.comp_name = "SwitchSPST_v1_0";
    defparam SW1_1.port_names = "T1, T2";
    defparam SW1_1.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("01f21b54-d866-4847-8e25-9070fdb75c89"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 SW1_2 (
        .connect({
            Net_2310,
            Net_2312
        })
    );
    defparam SW1_2.comp_name = "SwitchSPST_v1_0";
    defparam SW1_2.port_names = "T1, T2";
    defparam SW1_2.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("f8c50354-0db0-4b24-a3b1-ccfd011eea48"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 SW1_3 (
        .connect({
            Net_2313,
            Net_2315
        })
    );
    defparam SW1_3.comp_name = "SwitchSPST_v1_0";
    defparam SW1_3.port_names = "T1, T2";
    defparam SW1_3.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("5a64f311-56c2-4d07-ac24-c193c288c547"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
