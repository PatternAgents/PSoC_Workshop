...
/* Signal present */
#define ResetTimer_QUAD_INDEX_SIGNAL_PRESENT      (1lu)
#define ResetTimer_QUAD_STOP_SIGNAL_PRESENT       (1lu)
...
#define ResetTimer_PWM_OUT_N_INVERT               (1lu)
#define ResetTimer_PWM_OUT_INVERT                 (0lu)
#define ResetTimer_PWM_ALIGN                      (1lu)
...
#define ResetTimer_PWM_START_SIGNAL_MODE          (3lu)
...
#define ResetTimer_PWM_COUNT_SIGNAL_PRESENT       (1lu)
#define ResetTimer_PWM_START_SIGNAL_PRESENT       (1lu)
#define ResetTimer_PWM_STOP_SIGNAL_PRESENT        (0lu)
#define ResetTimer_PWM_SWITCH_SIGNAL_PRESENT      (0lu)

/* Interrupt Mask */
#define ResetTimer_PWM_INTERRUPT_MASK             (0lu)
