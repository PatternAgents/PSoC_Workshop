// ======================================================================
// LAB_TWO.v generated from TopDesign.cysch
// 08/26/2015 at 14:23
...
`ifdef WARP
`define CY_BLK_DIR "$CYPRESS_DIR\..\psoc\content\cyprimitives\CyPrimitives.cylib\xnor_v1_0"
`include "$CYPRESS_DIR\..\psoc\content\cyprimitives\CyPrimitives.cylib\xnor_v1_0\xnor_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\xnor_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\xnor_v1_0\xnor_v1_0.v"
`endif
...
module top ;
    ...
    assign USER_LED_1 = ~(GPIO0_6 & Net_1406 & USER_SW_1);


    assign Net_1406 = ~(Net_257 ^ Net_184);

    assign Net_1063 = 1'h1;
	...
	cy_clock_v1_0
		#(.id("fbf4d7ad-70e1-436d-8ef8-72116c30410a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("200000000000"),
		  .is_direct(0),
