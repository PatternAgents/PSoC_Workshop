...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        P0_6_PC =   (P0_6_PC & \
                                (uint32)(~(uint32)(P0_6_DRIVE_MODE_IND_MASK << (P0_6_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (P0_6_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
    uint8 drVal = (uint8)(P0_6_DR & (uint8)(~P0_6_MASK));
    drVal = (drVal | ((uint8)(value << P0_6_SHIFT) & P0_6_MASK));
    P0_6_DR = (uint32)drVal;
}
...
{
	SetP4PinDriveMode(P0_6__0__SHIFT, mode);
}
...
{
    return (uint8)((P0_6_PS & P0_6_MASK) >> P0_6_SHIFT);
}
...
{
    return (uint8)((P0_6_DR & P0_6_MASK) >> P0_6_SHIFT);
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		uint8 maskedStatus = (uint8)(P0_6_INTSTAT & P0_6_MASK);
		P0_6_INTSTAT = maskedStatus;
        return maskedStatus >> P0_6_SHIFT;
    }
